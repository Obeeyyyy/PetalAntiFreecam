...
import com.boggy.petalantifreecam.PetalAntiFreecam;
...
public final class ChunkRefreshScheduler {
    ...
    public ChunkRefreshScheduler(PetalAntiFreecam plugin, ConfigurationManager configurationManager) {
        this.plugin = plugin;
    ...
    private void scheduleRefresh(ChunkRefreshKey refreshKey) {
        ...
        // we don't want to wait an extra tick for no reason if we're not on folia
